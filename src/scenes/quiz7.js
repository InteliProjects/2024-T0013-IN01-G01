class QuizGame7 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.html("question7", "./src/components/questions/question7.html");
        this.load.html("contador", "./src/components/contador.html");
        this.load.html("answer7", "./src/components/questions/answer7.html");
    ...
    create() {
        ...
        this.questao7 = this.add.dom((this.game.config.width) / 2, (this.game.config.height) / 2).createFromCache('question7').setScale(window.innerWidth * 0.0025);
        this.feedback7 = this.add.dom((this.game.config.width - (this.game.config.width + 50)) / 2, (this.game.config.height - this.game.config.height) / 2).createFromCache('answer7');
        ...
        this.intervalo = setInterval(() => {
            if (document.getElementById('contador').innerHTML == 0 && document.getElementById('textAnswer').innerHTML == "") {
                ...
                document.getElementById("answer7").classList.remove("d-none")
        ...
        document.getElementById("answer7a").addEventListener("click", (event) => {
        ...
        document.getElementById("answer7b").addEventListener("click", (event) => {
            this.resposta = "Quase lá! Tente novamente."; //texto da resposta
            this.tempoResposta = document.getElementById('contador').innerHTML; //Pegar o tempo atual que a pergunta foi respondida
            this.somerro.play(); //tocar som de erro
        });
        document.getElementById("answer7c").addEventListener("click", (event) => {
            this.resposta = "Resposta Correta!"; //texto da resposta
            this.tempoResposta = document.getElementById('contador').innerHTML; //Pegar o tempo atual que a pergunta foi respondida
            this.somacerto.play(); //tocar som de acerto
        });
        document.getElementById("answer7d").addEventListener("click", (event) => {
            this.resposta = "Quase lá! Tente novamente."; //texto da resposta
            this.tempoResposta = document.getElementById('contador').innerHTML; //Pegar o tempo atual que a pergunta foi respondida
            this.somerro.play(); //tocar som de erro
        });
        ...
        play.addEventListener("click", (event) => {
            ...
            this.scene.start('QuizGame8'); //troca para nova cena (quiz ou cenário)
        });
        ...
        switch (this.personagemEscolhido) {
            case 'lavinia':
                document.getElementById("img-quiz7").src = './assets/questions/question7/question7_lavinia.png';
                break;
            case 'alex':
                document.getElementById("img-quiz7").src = './assets/questions/question7/question7_alex.png';
                break;
            case 'enzo':
                document.getElementById("img-quiz7").src = './assets/questions/question7/question7_enzo.png';
                break;
            case 'mauro':
                document.getElementById("img-quiz7").src = './assets/questions/question7/question7_mauro.png';
                break;
            case 'bruna':
                document.getElementById("img-quiz7").src = './assets/questions/question7/question7_bruna.png';
                break;
            default:
                document.getElementById("img-quiz7").src = './assets/questions/question7/question7_lavinia.png';
                break;
    ...
    armazenaTrofeu(trofeuValor) {
        ...
        this.trofeusArray.splice(6, 1, trofeuValor);
