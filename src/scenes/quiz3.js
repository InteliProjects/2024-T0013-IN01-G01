class QuizGame3 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.html("question3", "./src/components/questions/question3.html");
        this.load.html("contador", "./src/components/contador.html");
        this.load.html("answer3", "./src/components/questions/answer3.html");
    ...
    create() {
        ...
        this.questao3 = this.add.dom((this.game.config.width) / 2, (this.game.config.height) / 2).createFromCache('question3').setScale(window.innerWidth * 0.0025);
        this.feedback3 = this.add.dom((this.game.config.width - (this.game.config.width + 50)) / 2, (this.game.config.height - this.game.config.height) / 2).createFromCache('answer3');
        ...
        document.getElementById("answer3a").addEventListener("click", (event) => {
        ...
        document.getElementById("answer3b").addEventListener("click", (event) => {
            this.resposta = "Quase lá! Tente novamente."; //texto da resposta
            this.tempoResposta = document.getElementById('contador').innerHTML; //Pegar o tempo atual que a pergunta foi respondida
            this.somerro.play(); //tocar som de erro
        });
        document.getElementById("answer3c").addEventListener("click", (event) => {
            this.resposta = "Quase lá! Tente novamente."; //texto da resposta
            this.tempoResposta = document.getElementById('contador').innerHTML; //Pegar o tempo atual que a pergunta foi respondida
            this.somerro.play(); //tocar som de erro
        });
        document.getElementById("answer3d").addEventListener("click", (event) => {
        ...
        play.addEventListener("click", (event) => {
            ...
            this.scene.start('QuizGame4', this.game);
        });
    ...
    armazenaTrofeu(trofeuValor) {
        ...
        this.trofeusArray.splice(2, 1, trofeuValor);
