class QuizGame9 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.html("question9", "./src/components/questions/question9.html");
        this.load.html("contador", "./src/components/contador.html");
        this.load.html("answer9", "./src/components/questions/answer9.html");
    ...
    create() {
        ...
        this.questao9 = this.add.dom((this.game.config.width) / 2, (this.game.config.height) / 2).createFromCache('question9').setScale(window.innerWidth * 0.0025);
        this.feedback9 = this.add.dom((this.game.config.width - (this.game.config.width + 50)) / 2, (this.game.config.height - this.game.config.height) / 2).createFromCache('answer9');
        ...
        this.intervalo = setInterval(() => {
            if (document.getElementById('contador').innerHTML == 0 && document.getElementById('textAnswer').innerHTML == "") {
                ...
                document.getElementById("answer9").classList.remove("d-none")
        ...
        document.getElementById("answer9a").addEventListener("click", (event) => {
        ...
        document.getElementById("answer9b").addEventListener("click", (event) => {
            this.resposta = "Quase lá! Tente novamente."; //texto da resposta
            this.tempoResposta = document.getElementById('contador').innerHTML; //Pegar o tempo atual que a pergunta foi respondida
            this.somerro.play(); //tocar som de erro
        });
        document.getElementById("answer9c").addEventListener("click", (event) => {
            this.resposta = "Resposta Correta!"; //texto da resposta
            this.tempoResposta = document.getElementById('contador').innerHTML; //Pegar o tempo atual que a pergunta foi respondida
            this.somacerto.play(); //tocar som de acerto
        });
        document.getElementById("answer9d").addEventListener("click", (event) => {
            this.resposta = "Quase lá! Tente novamente."; //texto da resposta
            this.tempoResposta = document.getElementById('contador').innerHTML; //Pegar o tempo atual que a pergunta foi respondida
            this.somerro.play(); //tocar som de erro
        });
        ...
        //Lógica para passar para proximo nível
        var play = document.getElementById("nextLevel");
        play.addEventListener("click", (event) => {
            clearInterval(this.intervalo);
            this.trofeuHud.destroy();
            this.scene.start('QuizGame10'); //troca para nova cena (quiz ou cenário)
        });
        ...
        switch (this.personagemEscolhido) {
            case 'lavinia':
                document.getElementById("img-quiz9").src = './assets/questions/question9/question9_lavinia.png';
                break;
            case 'alex':
                document.getElementById("img-quiz9").src = './assets/questions/question9/question9_alex.png';
                break;
            case 'enzo':
                document.getElementById("img-quiz9").src = './assets/questions/question9/question9_enzo.png';
                break;
            case 'mauro':
                document.getElementById("img-quiz9").src = './assets/questions/question9/question9_mauro.png';
                break;
            case 'bruna':
                document.getElementById("img-quiz9").src = './assets/questions/question9/question9_bruna.png';
                break;
            default:
                document.getElementById("img-quiz9").src = './assets/questions/question9/question9_lavinia.png';
                break;
    ...
    armazenaTrofeu(trofeuValor) {
        ...
        this.trofeusArray.splice(8, 1, trofeuValor);
