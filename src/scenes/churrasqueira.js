class Churrasqueira extends Phaser.Scene {
    constructor() {
        super({
            key: 'Churrasqueira'
        });
    ...
    preload() {
        ...
        this.load.image('churrasqueira', './assets/cenas/churrasco.jpeg');
    ...
    create() {
        ...
        const background = this.add.image(0, 0, 'churrasqueira').setOrigin(0, 0);
