class Rua extends Phaser.Scene {
    constructor() {
        super({
            key: 'Rua'
        });
    ...
    preload() {
        ...
        this.load.image('rua', './assets/cenas/rua.png');
    ...
    create() {
        ...
        const background = this.add.image(0, 0, 'rua').setOrigin(0, 0);
        ...
        //Sistema de legenda
        this.arrayLegendas = [
            "  Ao sair na rua devemos ter\n  cuidado pois estamos\npropensos a ",
            "\n ... acidentes graças\na exposição solar \ne outros perigos\n",
            " É muito importante\n sempre evitar exposições\n desnecessárias ao sol\n e a outros riscos"
        ];
        this.legendaIndex = 0;
        this.legendaEstilo = {
            fill: '#000',
