class QuizGame5 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.html("question5", "./src/components/questions/question5.html");
        this.load.html("contador", "./src/components/contador.html");
        this.load.html("answer5", "./src/components/questions/answer5.html");
    ...
    create() {
        ...
        this.questao5 = this.add.dom((this.game.config.width) / 2, (this.game.config.height) / 2).createFromCache('question5').setScale(window.innerWidth * 0.0025);
        this.feedback5 = this.add.dom((this.game.config.width - (this.game.config.width + 50)) / 2, (this.game.config.height - this.game.config.height) / 2).createFromCache('answer5');
        ...
        document.getElementById("answer5a").addEventListener("click", (event) => {
        ...
        document.getElementById("answer5b").addEventListener("click", (event) => {
            this.resposta = "Resposta Correta!"; //texto da resposta
            this.tempoResposta = document.getElementById('contador').innerHTML; //Pegar o tempo atual que a pergunta foi respondida
            this.somacerto.play(); //tocar som de acerto
        });
        document.getElementById("answer5c").addEventListener("click", (event) => {
            this.resposta = "Quase lá! Tente novamente."; //texto da resposta
            this.tempoResposta = document.getElementById('contador').innerHTML; //Pegar o tempo atual que a pergunta foi respondida
            this.somerro.play(); //tocar som de erro
        });
        document.getElementById("answer5d").addEventListener("click", (event) => {
            this.resposta = "Quase lá! Tente novamente."; //texto da resposta
            this.tempoResposta = document.getElementById('contador').innerHTML; //Pegar o tempo atual que a pergunta foi respondida
            this.somerro.play(); //tocar som de erro
        });
        ...
        play.addEventListener("click", (event) => {
            ...
            this.scene.start('QuizGame6'); //troca para nova cena (quiz ou cenário)
        });
        ...
        switch (this.personagemEscolhido) {
            case 'lavinia':
                document.getElementById("img-quiz5").src = './assets/questions/question5/question5_lavinia.png';
                break;
            case 'alex':
                document.getElementById("img-quiz5").src = './assets/questions/question5/question5_alex.png';
                break;
            case 'enzo':
                document.getElementById("img-quiz5").src = './assets/questions/question5/question5_enzo.png';
                break;
            case 'mauro':
                document.getElementById("img-quiz5").src = './assets/questions/question5/question5_mauro.png';
                break;
            case 'bruna':
                document.getElementById("img-quiz5").src = './assets/questions/question5/question5_bruna.png';
                break;
            default:
                document.getElementById("img-quiz5").src = './assets/questions/question5/question5_lavinia.png';
                break;
    ...
    armazenaTrofeu(trofeuValor) {
        ...
        this.trofeusArray.splice(4, 1, trofeuValor);
