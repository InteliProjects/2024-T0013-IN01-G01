class Lavanderia extends Phaser.Scene {
    constructor() {
        super({
            key: 'Lavanderia'
        });
    ...
    preload() {
        ...
        this.load.image('lavanderia', './assets/cenas/lavanderia.jpeg');
    ...
    create() {
        ...
        const background = this.add.image(0, 0, 'lavanderia').setOrigin(0, 0);
        ...
        //Sistema de legenda
        this.arrayLegendas = [
            "\n Na lavanderia acidentes\nocorrem com frequência\n",
            "\n...devido ao\n contato direto \ncom o ferro de passar\n",
            "\n É muito importante\n sempre manter a atenção\n"
        ];
        this.legendaIndex = 0;
        this.legendaEstilo = {
            fill: '#000',
